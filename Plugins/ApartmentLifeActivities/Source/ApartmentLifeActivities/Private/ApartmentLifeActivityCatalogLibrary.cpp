...
TArray<FApartmentLifeActivityDefinition> UApartmentLifeActivityCatalogLibrary::GetBuiltinCatalog()
{
	TArray<FApartmentLifeActivityDefinition> Catalog = {
		...
		MakeActivity(TEXT("activity.work.content_edit"), TEXT("Content Editing"), EApartmentLifeActivityCategory::Work, EApartmentLifeActivityRoom::Office, EApartmentLifeAnimationGroup::ComputerUse, 75, Stats(1, -7, 0, 4, -1, 2, 4), 0, true),
		MakeActivity(TEXT("activity.work.data_entry"), TEXT("Data Entry"), EApartmentLifeActivityCategory::Work, EApartmentLifeActivityRoom::Office, EApartmentLifeAnimationGroup::ComputerUse, 60, Stats(0, -6, 0, 3, -1, 1, 3), 0, true),
		MakeActivity(TEXT("activity.work.virtual_assistant"), TEXT("Virtual Assistant"), EApartmentLifeActivityCategory::Work, EApartmentLifeActivityRoom::Office, EApartmentLifeAnimationGroup::ComputerUse, 60, Stats(1, -5, 0, 3, 0, 2, 3), 0, true),
		MakeActivity(TEXT("activity.work.writing"), TEXT("Writing Task"), EApartmentLifeActivityCategory::Work, EApartmentLifeActivityRoom::Office, EApartmentLifeAnimationGroup::ComputerUse, 90, Stats(2, -7, 0, 4, 1, 3, 3), 0, true),
		MakeActivity(TEXT("activity.work.design"), TEXT("Freelance Design"), EApartmentLifeActivityCategory::Work, EApartmentLifeActivityRoom::Office, EApartmentLifeAnimationGroup::ComputerUse, 90, Stats(3, -8, 0, 4, 2, 4, 4), 0, true),
